package com.rajaryan.todo_list.model;
...
public class BlockModel {
    ...
    public BlockModel(int index, long timestamp, String previousHash, String data) {
        ...
        this.data = data;
        nonce=0;
        hash=BlockModel.calculate_hash(this);
    }

    public static String calculate_hash(BlockModel blockModel) {
        if (blockModel!=null){
    ...
    private String str() {
        return  index+previousHash+data+nonce;
    }
